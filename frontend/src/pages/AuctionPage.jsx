...
const AuctionPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <h1 className="text-3xl font-bold mb-6">Live Crop Auctions</h1>
      ...
      {selectedAuction ? (
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded shadow">
            <h2 className="text-xl font-bold">{selectedAuction.cropName}</h2>
            ...
            <div className="mt-6 h-64">
              <h3 className="font-bold mb-3">Live Trading Chart</h3>
          ...
          <div className="bg-white p-6 rounded shadow">
            <h3 className="text-lg font-bold mb-4">Live Bids</h3>
            ...
            {liveBids.map((bid, i) => (
              <div key={i} className="flex justify-between border-b py-2">
                <div>
                  <p className="text-sm font-semibold">{bid.bidder}</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {auctions.map((auction) => {
            ...
            return (
              <div key={auction._id} className="bg-white p-6 rounded shadow">
                <h2 className="text-xl font-bold">{auction.cropName}</h2>
